...
public abstract class AIPlayer : Player
{
	...
	protected class Location
	{
		...
		public static bool ReferenceEquals(Location @this, Location other)  
		{
		...
		///  Removing the below as ReferenceEquals() has been utilised above

		/// public static bool  ReferenceEquals(Location @this, Location other)
		/// {
		/// 	return @this == null || other == null || @this.Row != other.Row || @this.Column != other.Column;
		/// }
		/// operator !=(Location @this, Location other) - replaced by ReferenceEquals
	}
